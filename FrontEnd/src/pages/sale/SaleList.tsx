...
const SaleList : React.FC = () => {
    ...
    useEffect(() => {
        ...
        setField([
            ...
            {key: "Discount", label: "Discount %", class: "", sortable: true, sortValue: 'none'},
    ...
    const handleComponentEdit: React.FC =( ) => {
        return  (<SaleAdd loadDataTable={loadDataTable} form={'edit'} id={currentId} />)
    }
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $axios.delete(`Author/${item.Id}`).then(res => {
                    ...
                    loadDataTable()
                    dispatch(setToast({status: 'success', message: 'Success', data: 'Delete discount successful'}))
